...
#ifdef INFINTY_CONFIG_ACPI_OSL_VERBOSE
...
void* AcpiOsAllocate(ACPI_SIZE size){
    ...
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Allocate(size=%u)=%p\n", size, memory);
...
void AcpiOsFree(void* p){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Free(p=%p)\n", p);
...
ACPI_STATUS AcpiOsSignal(UINT32 function, void* info){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Signal\n");
...
ACPI_THREAD_ID AcpiOsGetThreadId(){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: GetThreadId\n");
...
void AcpiOsSleep(UINT64 ms){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Sleep\n");
...
void AcpiOsStall(UINT32 us){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Stall\n");
...
ACPI_STATUS AcpiOsExecute(ACPI_EXECUTE_TYPE /*type*/, ACPI_OSD_EXEC_CALLBACK function, void* context){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: Execute\n");
...
UINT64 AcpiOsGetTimer(){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: GetTimer\n");
...
void AcpiOsWaitEventsComplete(){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: WaitEventsComplete\n");
...
ACPI_PHYSICAL_ADDRESS AcpiOsGetRootPointer(){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: GetRootPointer\n");
...
void* AcpiOsMapMemory(ACPI_PHYSICAL_ADDRESS phys, ACPI_SIZE length){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: MapMemory\n");
...
void AcpiOsUnmapMemory(void* virt_raw, ACPI_SIZE length){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: UnmapMemory\n");
...
ACPI_STATUS AcpiOsCreateMutex(ACPI_MUTEX* handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: CreateMutex\n");
...
void AcpiOsDeleteMutex(ACPI_MUTEX handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: DeleteMutex\n");
...
ACPI_STATUS AcpiOsAcquireMutex(ACPI_MUTEX handle, UINT16 Timeout){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: AcquireMutex\n");
...
void AcpiOsReleaseMutex(ACPI_MUTEX handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: ReleaseMutex\n");
...
ACPI_STATUS AcpiOsCreateSemaphore(UINT32 /*maxUnits*/, UINT32 initialUnits, ACPI_SEMAPHORE* handle){
    ...
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: CreateSemaphore(initial=%u)=%p\n", initialUnits, lock);
...
ACPI_STATUS AcpiOsDeleteSemaphore(ACPI_SEMAPHORE handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: DeleteSemaphore\n");
...
ACPI_STATUS AcpiOsWaitSemaphore(ACPI_SEMAPHORE handle, UINT32 units, UINT16 timeout){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: WaitSemaphore(handle=%p,units=%u,timeout=%u)\n", handle, units, timeout);
...
ACPI_STATUS AcpiOsSignalSemaphore(ACPI_SEMAPHORE handle, UINT32 units){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: SignalSemaphore\n");
...
ACPI_STATUS AcpiOsCreateLock(ACPI_SPINLOCK *handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: CreateLock\n");
...
void AcpiOsDeleteLock(ACPI_HANDLE handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: DeleteLock\n");
...
ACPI_CPU_FLAGS AcpiOsAcquireLock(ACPI_SPINLOCK handle){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: acquireLock\n");
...
void AcpiOsReleaseLock(ACPI_SPINLOCK handle, ACPI_CPU_FLAGS /*flags*/){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: ReleaseLock\n");
...
ACPI_STATUS AcpiOsReadPort(ACPI_IO_ADDRESS port, UINT32* value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: ReadPort\n");
...
ACPI_STATUS AcpiOsWritePort(ACPI_IO_ADDRESS port, UINT32 value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: WritePort\n");
...
ACPI_STATUS AcpiOsReadMemory(ACPI_PHYSICAL_ADDRESS Address, UINT64 *value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: ReadMemory\n");
...
ACPI_STATUS AcpiOsWriteMemory(ACPI_PHYSICAL_ADDRESS Address, UINT64 value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: WriteMemory\n");
...
ACPI_STATUS AcpiOsReadPciConfiguration(ACPI_PCI_ID* pci_id, UINT32 Register, UINT64* value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: ReadPciConfiguration\n");
...
ACPI_STATUS AcpiOsWritePciConfiguration(ACPI_PCI_ID* pci_id, UINT32 Register, ACPI_INTEGER value, UINT32 width){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: WritePciConfiguration\n");
...
ACPI_STATUS AcpiOsInstallInterruptHandler(UINT32 irq, ACPI_OSD_HANDLER routine, void* context){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: InstallInterruptHandler\n");
...
ACPI_STATUS AcpiOsRemoveInterruptHandler(UINT32 irq, ACPI_OSD_HANDLER routine){
    verbose_logf(logging::log_level::TRACE, "infinity:acpica:osl: RemoveInterruptHandler\n");
