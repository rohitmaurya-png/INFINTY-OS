...
path get_fs_path(const path& base_path, const mounted_fs& fs) {
    infinity_assert(base_path.is_absolute(), "Invalid base_path in get_fs_path");
    infinity_assert(fs.mount_point.is_absolute(), "Invalid base_path in get_fs_path");
...
#ifdef INFINTY_CONFIG_DEBUG_VFS
